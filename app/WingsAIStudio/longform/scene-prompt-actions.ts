...
**애니메이션2 스타일의 경우:**
- ⚠️ 스틱맨(stickman)이 절대 나오면 안 됩니다.
- 프롬프트에 "stickman", "stick figure", "stick man" 등의 단어를 사용하지 마세요.
- 일반적인 스타일화된 카툰 캐릭터를 사용하세요.
