...
import { BarChart3, Loader2, TrendingUp, AlertCircle, Brain, FileText, Eye, Heart, MessageSquare, Bookmark, ShoppingBag, ExternalLink, Play, Sparkles } from "lucide-react"
...
export default function ChannelAnalysisPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#0c1214] text-zinc-100">
      ...
      <BenchmarkHeader activeTab="my-channel" />
          ...
          {!analysisResult ? (
            <>
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-teal-600/15 via-cyan-500/10 to-sky-600/15 blur-3xl rounded-3xl"></div>
                <Card className="relative border border-white/10 bg-white/[0.03] backdrop-blur-xl shadow-2xl">
                  <CardHeader className="pb-4">
                    <div className="flex items-center gap-4 mb-2">
                      <div className="p-3 rounded-2xl bg-gradient-to-br from-teal-500 to-cyan-600 shadow-lg shadow-teal-900/40">
                        <BarChart3 className="w-7 h-7 text-white" />
                      </div>
                      <div>
                        <CardTitle className="text-2xl font-bold text-white mb-1 md:text-3xl">
                          내 채널 진단
                        </CardTitle>
                        <p className="text-zinc-400 text-sm font-medium">
                          YouTube 채널 데이터를 모아 AI가 성장·전략 포인트를 정리합니다
                        </p>
                      </div>
                    </div>
                  </CardHeader>
            ...
            <>
                  ...
                  <div className="flex items-start gap-8">
                    ...
                    <div className="flex items-start gap-5">
                      ...
                      <div>
                        ...
                        <p className="text-slate-400 text-sm mb-4">채널 진단 결과</p>
                        <Button
                          size="sm"
                          variant="outline"
                    ...
                    <div className="flex-1 flex items-center gap-8">
                      ...
                      <div className="p-4 rounded-2xl bg-gradient-to-br from-purple-500/10 to-teal-500/10 border border-purple-500/20 backdrop-blur-sm">
                        <p className="text-slate-400 text-xs font-medium mb-2 uppercase tracking-wider">총 영상 수</p>
                        <p className="text-3xl font-bold bg-gradient-to-r from-purple-400 to-teal-400 bg-clip-text text-transparent">
              ...
              <div className="flex justify-center">
                <Button
                  ...
                  size="lg"
                  className="bg-gradient-to-r from-orange-600 via-red-500 to-teal-600 hover:from-orange-500 hover:via-red-400 hover:to-teal-500 text-white font-semibold shadow-lg shadow-orange-500/50 hover:shadow-xl hover:shadow-orange-500/50 transform hover:scale-[1.02] transition-all duration-300 px-8 py-6"
                >
              ...
              <Tabs defaultValue="popularity" className="space-y-6">
                  <TabsList className="grid w-full grid-cols-5 bg-slate-800/50 p-1.5 rounded-xl border border-slate-700/50 backdrop-blur-sm">
                    ...
                    <TabsTrigger 
                      value="likes" 
                      className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-teal-500 data-[state=active]:to-rose-500 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-teal-500/50 text-xs text-slate-300 data-[state=active]:border-0 transition-all"
                    >
                  ...
                  <TabsContent value="likes" className="space-y-6">
                    <Card className="border border-slate-700/50 bg-slate-800/30 backdrop-blur-xl shadow-2xl">
                      <CardHeader className="border-b border-slate-700/50">
                        <CardTitle className="text-xl font-bold text-white flex items-center gap-2">
                          <div className="p-1.5 rounded-lg bg-gradient-to-br from-teal-500/20 to-rose-500/20 border border-teal-500/30">
                              ...
                              content={({ active, payload }) => {
                                if (active && payload && payload.length) {
                                  return (
                                    <div className="bg-slate-800/95 backdrop-blur-xl p-4 border border-slate-700/50 rounded-xl shadow-2xl">
                                      <p className="font-semibold text-white mb-2 text-sm">{payload[0].payload.fullTitle}</p>
                                      <p className="text-teal-400 font-bold text-lg">좋아요: {payload[0].value?.toLocaleString()}</p>
                                    </div>
                                  )
                                }
                                return null
