...
export const MVP_LABELS = {
  ...
  tabDirectUrl: `URL 직접 입력 (다중 소스 리믹스, 최대 ${MAX_AUTO_EDIT_VIDEOS}개)`,
  tabReprocess: "재가공 AI편집 (YouTube·TikTok)",
  keywordHint:
    "한국어 키워드를 입력한 뒤 「중국어로 번역」을 누르세요. 번역이 끝나면 「소스찾기」가 활성화됩니다.",
  multiKeyword: "여러 키워드 (줄바꿈·쉼표)",
  keywordPlaceholder: "예: 차량용 청소기",
  multiKeywordPlaceholder: "차량용 청소기\n무선 차량 청소기",
  translating: "중국어 변환 중…",
  translateBtn: "중국어로 번역",
  translateFirst: "먼저 「중국어로 번역」을 눌러 주세요.",
  openaiKeyHint: "ShotForm 설정에서 OpenAI API 키를 저장해야 중국어 번역을 사용할 수 있습니다.",
  searching: "소스 찾는 중…",
  searchBtn: "소스찾기",
  directUrlHint:
    `도우인·샤오홍슈·TikTok URL을 입력한 뒤 「URL 해석」으로 영상을 확인하세요. 하단 「AI 리믹스」로 편집을 시작합니다. 기본 2칸, + 버튼으로 최대 ${MAX_AUTO_EDIT_VIDEOS}개까지 넣을 수 있으며, 리믹스는 버튼을 눌러야 시작됩니다.`,
  reprocessHint:
    "YouTube·TikTok URL을 넣고 「AI 리믹스」를 누르면 영상을 받아온 뒤 바로 리믹스가 시작됩니다.",
  apifyLoading: "도우인 · 샤오홍슈 검색 중… (최대 수 분)",
  steps: {
    urlInput: "URL 입력",
    urlResolve: "URL 해석",
    keywordInput: "키워드 입력",
  ...
  footer: {
    direct:
      "URL을 해석하면 최대 {count}개 영상이 소스로 선택됩니다. 하단 「AI 리믹스」로 편집을 시작하세요. 이후 TTS·자막·썸네일·보내기 순으로 진행합니다.",
    reprocess:
      "URL 해석 후 AI 리믹스가 바로 실행됩니다. 이후 TTS·자막·썸네일·보내기까지 기존과 같습니다.",
    keyword:
      "도우인·샤오홍슈에서 영상을 최대 {max}개까지 골라 AI 리믹스를 실행하세요. 이후 영상 편집에서 TTS·자막을 만들고 썸네일·보내기까지 이어갑니다.",
  },
  videoCard: {
    presenterTitle: "입방송·블로거 소개 영상 (리믹스 제외)",
    deselect: "선택 해제",
    add: "영상에 추가",
    douyin: "도우인",
    xhs: "샤오홍슈",
    presenterBadge: "입방송 추정",
    length: "길이",
    views: "조회",
    likes: "좋아요",
    relevance: "관련도",
  ...
  errors: {
    ...
    presenterPick:
      "입방송·블로거 소개 영상은 리믹스에 넣을 수 없습니다. 다른 영상을 골라 주세요.",
    maxPicks: "최대 {max}개까지만 선택할 수 있습니다.",
    maxEdit: "리믹스는 최대 {max}개 영상까지만 가능합니다.",
...
export function formatSearchRetryNotice(queries: string[], douyin: number, xhs: number): string {
  return `검색어「${queries.join(" · ")}」— 도우인 ${douyin}건 · 샤오홍슈 ${xhs}건`
}
